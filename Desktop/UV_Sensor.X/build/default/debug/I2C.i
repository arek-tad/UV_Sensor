...
uint8_t I2C_Write(uint8_t data) {
    ...
    for (bitCount = 0; bitCount < 8; bitCount++) {
        TRISBbits.TRISB0 = (data & 0x80) ? 1 : 0;
        _delay((unsigned long)((50)*(64000000/4000000.0)));
        TRISBbits.TRISB1 = 1;
        _delay((unsigned long)((50)*(64000000/4000000.0)));
        data <<= 1;
...
void UVSensor_Init(void) {
    AS7331_write_reg(0x00, 0x82);
    _delay((unsigned long)((10)*(64000000/4000.0)));

    AS7331_write_reg(6, 0b00000110);
    AS7331_write_reg(7, 0b01000000);
 AS7331_write_reg(8, 0b00000110);

    AS7331_write_reg(0x00, 0x83);
}
